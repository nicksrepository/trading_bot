...
-- Started on 2024-09-06 21:34:50
...
-- Name: hourly_data_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.hourly_data_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.hourly_data_id_seq OWNER TO postgres;

--
-- TOC entry 4924 (class 0 OID 0)
-- Dependencies: 230
-- Name: hourly_data_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.hourly_data_id_seq OWNED BY public.hourly_data.id;
...
--
-- TOC entry 4732 (class 2604 OID 16760)
...
--
-- TOC entry 4733 (class 2604 OID 16779)
...
--
-- TOC entry 4730 (class 2604 OID 16728)
...
--
-- TOC entry 4728 (class 2604 OID 16698)
...
--
-- TOC entry 4734 (class 2604 OID 16807)
-- Name: hourly_data id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.hourly_data ALTER COLUMN id SET DEFAULT nextval('public.hourly_data_id_seq'::regclass);


--
-- TOC entry 4731 (class 2604 OID 16744)
...
--
-- TOC entry 4729 (class 2604 OID 16714)
...
--
-- TOC entry 4727 (class 2604 OID 16687)
...
--
-- TOC entry 4754 (class 2606 OID 16764)
...
--
-- TOC entry 4756 (class 2606 OID 16783)
...
--
-- TOC entry 4746 (class 2606 OID 16732)
...
--
-- TOC entry 4748 (class 2606 OID 16734)
...
-- Name: hourly_data hourly_data_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.hourly_data
    ADD CONSTRAINT hourly_data_pkey PRIMARY KEY (id);


--
-- TOC entry 4762 (class 2606 OID 16813)
-- Name: hourly_data hourly_data_ticker_id_timestamp_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.hourly_data
    ADD CONSTRAINT hourly_data_ticker_id_timestamp_key UNIQUE (ticker_id, "timestamp");


--
-- TOC entry 4750 (class 2606 OID 16748)
...
--
-- TOC entry 4752 (class 2606 OID 16750)
...
--
-- TOC entry 4758 (class 2606 OID 16797)
...
--
-- TOC entry 4744 (class 2606 OID 16718)
...
--
-- TOC entry 4736 (class 2606 OID 16691)
...
--
-- TOC entry 4738 (class 2606 OID 16693)
...
--
-- TOC entry 4763 (class 1259 OID 16819)
-- Name: idx_hourly_data_ticker_timestamp; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_hourly_data_ticker_timestamp ON public.hourly_data USING btree (ticker_id, "timestamp");


--
-- TOC entry 4768 (class 2606 OID 16765)
...
--
-- TOC entry 4769 (class 2606 OID 16770)
...
--
-- TOC entry 4766 (class 2606 OID 16735)
...
--
-- TOC entry 4764 (class 2606 OID 16705)
...
--
-- TOC entry 4771 (class 2606 OID 16814)
-- Name: hourly_data hourly_data_ticker_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.hourly_data
    ADD CONSTRAINT hourly_data_ticker_id_fkey FOREIGN KEY (ticker_id) REFERENCES public.tickers(ticker_id);


--
-- TOC entry 4767 (class 2606 OID 16751)
...
--
-- TOC entry 4770 (class 2606 OID 16798)
...
--
-- TOC entry 4765 (class 2606 OID 16719)
...
-- Completed on 2024-09-06 21:34:50
